...
/**
 * Enumeration for storing information about Directions, NORTH SOUTH EAST and
 * WEST.
 *
 * Stored here are the delta's if the robot is moved while in that direction and
 * also the other directions in relation.
 *
 * @author Paul Esson
 */
public enum Direction {
    ...
    /**
     *
     * This enumeration represents the 4 different directions the robot can be
     * facing.
     *
